...
jetpack.tabs.onReady(function(d) {
    ...
    if (pped >0) {
        ...
        csstxt = csstxt + "div#wunderpack table,\n";
        csstxt = csstxt + "div#wunderpack td,\n";
        csstxt = csstxt + "div#wunderpack tr,\n";
        csstxt = csstxt + "div#wunderpack p,\n";
        csstxt = csstxt + "div#wunderpack a {\n";
        csstxt = csstxt + "  color: black;\n";
        csstxt = csstxt + "  background-color: transparent;\n";
        csstxt = csstxt + "  border: 0;\n";
        csstxt = csstxt + "  font-family: arial;\n";
        csstxt = csstxt + "  font-weight: normal;\n";
        csstxt = csstxt + "  font-size: 13px;\n";
        csstxt = csstxt + "  font-style: normal;\n";
        csstxt = csstxt + "  text-align: left;\n";
        csstxt = csstxt + "  text-decoration: none;\n";
        csstxt = csstxt + "  text-indent: 0;\n";
        csstxt = csstxt + "  vertical-align: top;\n";
        csstxt = csstxt + "}\n";
        csstxt = csstxt + "div#wunderpack .wunderpackbutton {\n";
        csstxt = csstxt + "  float: left;\n";
        csstxt = csstxt + "  cursor: pointer;\n";
        csstxt = csstxt + "  padding: 0px 2px 0px 2px;\n";
        csstxt = csstxt + "}\n";
